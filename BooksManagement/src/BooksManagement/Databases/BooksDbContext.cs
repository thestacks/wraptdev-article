namespace BooksManagement.Databases;


using BooksManagement.Domain.Books;
using BooksManagement.Domain;
...
public class BooksDbContext : DbContext
{
    ...
    public BooksDbContext(
        DbContextOptions<BooksDbContext> options, ICurrentUserService currentUserService) : base(options)
    {

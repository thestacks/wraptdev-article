namespace BooksManagement.IntegrationTests.TestUtilities;
...
public static class DockerDatabaseUtilities
{
    ...
    private const string DB_NAME = "BooksManagement";
    private static readonly ImageTag ImageTagForOs = new ImageTag("postgres", "latest");
    private const string DB_CONTAINER_NAME = "IntegrationTesting_BooksManagement";
    private const string DB_VOLUME_NAME = "IntegrationTesting_BooksManagement";
